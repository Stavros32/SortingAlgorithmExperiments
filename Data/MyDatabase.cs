...
class MyDatabase
{
    ...
    public MyDatabase()
    {
        ...
        TShirt s19 = new TShirt(Color.VIOLET, Size.XL, Fabric.POLYESTER);
        TShirt s20 = new TShirt(Color.BLUE, Size.XL, Fabric.CASHMERE);
        ...
        TShirt s30 = new TShirt(Color.RED, Size.XXL, Fabric.COTTON);
        ...
        TShirt s40 = new TShirt(Color.BLUE, Size.XXXL, Fabric.CASHMERE);
